...
- Name: auth.spec.ts >> Authentication >> client role user can access the booking page after login
- Location: tests\e2e\auth.spec.ts:46:7
...
Expected: "http://127.0.0.1:3100/booking"
Received: "http://localhost:3100/login?callbackUrl=/booking"
Timeout:  5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    5 × unexpected value "http://127.0.0.1:3100/login?callbackUrl=/booking"
    9 × unexpected value "http://localhost:3100/login?callbackUrl=/booking"
